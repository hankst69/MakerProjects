...
:gr_clone_latest
echo GAMMARAY-CLONE %_GR_VERSION%
call "%MAKER_SCRIPTS%\clone_in_folder.bat" "%_GR_SOURCES_DIR%" "https://github.com/KDAB/GammaRay.git" --switchBranch master
goto :gr_clone_done

:gr_clone_version
echo GAMMARAY-CLONE %_GR_VERSION%
call "%MAKER_SCRIPTS%\clone_in_folder.bat" "%_GR_SOURCES_DIR%" "https://github.com/KDAB/GammaRay.git" --switchBranch %_GR_VERSION%
goto :gr_clone_done
