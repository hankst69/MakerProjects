...
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_VESC_FW_DIR%" "http://github.com/vedderb/bldc" %*
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_VESC_TOOL_DIR%" "https://github.com/vedderb/vesc_tool" %*
