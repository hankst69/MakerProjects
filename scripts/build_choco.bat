...
set "_CHOCO_VERSION=%MAKER_VERSION%"
rem apply defaults
...
rem CHOCO_DIR=%MAKER_ENV_BIN%\.choco
...
echo @pushd "%_CHOCO_BIN%">"%MAKER_ENV_BIN%\choco.bat"
rem echo @call choco.exe %%* --allow-unofficial --debug>>"%MAKER_ENV_BIN%\choco.bat"
