...
if "%_STARTT_HH%" equ "" set "_STARTT_HH=0"
if "%_STARTT_MM%" equ "" set "_STARTT_MM=0"
if "%_STARTT_SS%" equ "" set "_STARTT_SS=0"
...
if "%_STOPT_HH%" equ "" set "_STOPT_HH=0"
if "%_STOPT_MM%" equ "" set "_STOPT_MM=0"
if "%_STOPT_SS%" equ "" set "_STOPT_SS=0"
