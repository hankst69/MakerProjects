...
call "%MAKER_ENV_CORE%\compare_versions.bat" 3.13 %MAKER_VERSION% --no_errors --no_infos
...
call "%MAKER_ENV_CORE%\compare_versions.bat" 3.12 %MAKER_VERSION% --no_errors --no_infos
if %ERRORLEVEL% equ 0 goto :test_python
:python_311
...
call "%MAKER_ENV_CORE%\compare_versions.bat" 3.11 %MAKER_VERSION% --no_errors --no_infos
if %ERRORLEVEL% equ 0 goto :test_python
:python_310
...
call "%MAKER_ENV_CORE%\compare_versions.bat" 3.10 %MAKER_VERSION% --no_errors --no_infos
if %ERRORLEVEL% equ 0 goto :test_python
:python_39
...
call "%MAKER_ENV_CORE%\compare_versions.bat" 3.9 %MAKER_VERSION% --no_errors --no_infos
if %ERRORLEVEL% equ 0 goto :test_python
:python_38
...
call "%MAKER_ENV_CORE%\compare_versions.bat" 3.8 %MAKER_VERSION% --no_errors --no_infos
if %ERRORLEVEL% equ 0 goto :test_python
:python_37
...
call "%MAKER_ENV_CORE%\compare_versions.bat" 3.7 %MAKER_VERSION% --no_errors --no_infos
if %ERRORLEVEL% equ 0 goto :test_python
...
:test_python_success
if "%_PYTHON_NO_INFOS%" equ "" echo using: python %PYTHON_VERSION%
exit /b 0
