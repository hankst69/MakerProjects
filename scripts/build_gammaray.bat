...
if "%_GR_DIR%" EQU "" (echo cloning GammaRay %_GR_VERSION% failed &goto :_exit)
if "%_GR_SOURCES_DIR%" EQU "" (echo cloning GammaRay %_GR_VERSION% failed &goto :_exit)
if not exist "%_GR_DIR%" (echo cloning GammaRay %_GR_VERSION% failed &goto :_exit)
if not exist "%_GR_SOURCES_DIR%" (echo cloning GammaRay %_GR_VERSION% failed &goto :_exit)
