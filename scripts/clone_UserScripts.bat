...
@call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_USERSCRIPTS_DIR%\SingleFile-MV3" "https://github.com/gildas-lormeau/SingleFile-MV3"
@call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_USERSCRIPTS_DIR%\SaveChromeTabGroups" "https://github.com/sienori/Save-Tab-Groups-for-Tab-Session-Manager.git"
