...
set "MAKER_DIR_PROJECTS_OPENWEBRX=%MAKER_DIR_PROJECTS%\OpenWebRx"
set "_OPENWEBRX_DIR=%MAKER_DIR_PROJECTS_OPENWEBRX%"
set "_OPENWEBRX_SRC_DIR=%MAKER_DIR_PROJECTS_OPENWEBRX%\openwebrx"
set "_OPENWEBRX+_SRC_DIR=%MAKER_DIR_PROJECTS_OPENWEBRX%\openwebrx+"
