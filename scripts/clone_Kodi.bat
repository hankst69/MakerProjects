...
@rem https://github.com/b-jesch/plugin.video.ipcams
@rem https://github.com/hankst69/plugin.video.ipcams

@rem https://github.com/zag2me/script.hello.world
@rem https://github.com/hankst69/script.hello.world
...
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_KODI_PLUGINS_IPCAMS_DIR%" "https://github.com/hankst69/plugin.video.ipcams.git" --switchBranch Helix
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_KODI_SCRIPTS_HELLOWORLD_DIR%" "https://github.com/hankst69/script.hello.world.git"
