...
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_ROMO_FW_DIR%" "https://github.com/Navideck/Romo-Firmware.git" %*
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_ROMO_APP_DIR%" "https://github.com/Navideck/Romo.git" %*
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_ROMO_SDK_DIR%" "https://github.com/champierre/Romo.git" %*
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_ROMO_SCRATCH_DIR%" "https://github.com/Navideck/Scratch2Romo.git" %*
rem call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_ROMO_SCRATCH_DIR%" "https://github.com/champierre/Scratch2Romo.git" %*
call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_ROMO_ARKIT_DIR%" "https://github.com/laanlabs/HomeRobot.git" %*
