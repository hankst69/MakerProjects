@rem @call "%~dp0core\generic_validate.bat" "QT" "%QT_BIN_DIR%\bin\uic.exe --version" "for /f ""tokens=1,* delims= "" %%%%i in ('call %QT_BIN_DIR%\bin\uic.exe --version') do if /I %%%%i EQU uic echo %%%%j" %*
@echo off
