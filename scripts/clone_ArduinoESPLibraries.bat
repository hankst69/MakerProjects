...
rem https://github.com/T-vK/ESP32-BLE-Keyboard.git
...
call "%MAKER_SCRIPTS%\clone_in_folder.bat" "%_ARDUINO_LIBRARIES_DIR%\ESP32-BLE-Keyboard" "https://github.com/T-vK/ESP32-BLE-Keyboard.git"
