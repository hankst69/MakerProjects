...
set "WFVIEW_CHECKOUT_BRANCH=--switchBranch cmake_wasm"
rem if "%WFVIEW_VERSION_MAJOR%.%VERSION_MINOR%" equ "2.20" set "WFVIEW_CHECKOUT_BRANCH=--switchBranch v2.20-dev"
if "%MAKER_MSG_VERBOSE%" neq "" set WFVIEW_

call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%WFVIEW_SRC_DIR%" "https://gitlab.com/hankst69/wfview-wasm.git" %WFVIEW_CHECKOUT_BRANCH% %MAKER_MSG_SILENT%
