...
set "_EMSDK_VERSION=%MAKER_VERSION%"
rem apply defaults
...
set "_EMSDK_DIR=%MAKER_DIR_TOOLS%\EMSDK"
set "_EMSDK_BIN_DIR=%_EMSDK_DIR%\%_EMSDK_VERSION%"

call "%MAKER_ENV_CORE%\clone_in_folder.bat" "%_EMSDK_BIN_DIR%" "https://github.com/emscripten-core/emsdk.git" --changeDir
