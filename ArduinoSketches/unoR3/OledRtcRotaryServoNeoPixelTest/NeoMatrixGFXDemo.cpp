...
// Choose your prefered DEMO pixmap
//#include "NeoMatrixGFX/heart24.h"
//#include "NeoMatrixGFX/yellowsmiley24.h"
//#include "NeoMatrixGFX/bluesmiley24.h"
#include "NeoMatrixGFX/smileytongue24.h"
...
void NeoMatrixGFXDemo::setup(int neopixel_pin, int brightness)
{
  if (matrix) {
    return;
  }

#ifdef WS2812B64_SINGLE
  //#define BM32
...
void NeoMatrixGFXDemo::fixdrawRGBBitmap(int16_t x, int16_t y, const uint16_t *bitmap, int16_t w, int16_t h) {
...
void NeoMatrixGFXDemo::count_pixels() {
  matrix->clear();
...
void NeoMatrixGFXDemo::display_four_white() {
  matrix->clear();
...
void NeoMatrixGFXDemo::display_bitmap(uint8_t bmp_num, uint16_t color) {
...
void NeoMatrixGFXDemo::display_rgbBitmap(uint8_t bmp_num) {
  static uint16_t bmx,bmy;
...
void NeoMatrixGFXDemo::display_lines() {
  matrix->clear();
...
void NeoMatrixGFXDemo::display_boxes() {
  matrix->clear();
...
void NeoMatrixGFXDemo::display_circles() {
  matrix->clear();
...
void NeoMatrixGFXDemo::display_resolution() {
...
void NeoMatrixGFXDemo::display_scrollText() {
...
void NeoMatrixGFXDemo::display_panOrBounceBitmap (uint8_t bitmapSize) {
