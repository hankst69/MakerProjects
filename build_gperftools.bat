...
cd "%_GPT_SOURCES_DIR%"
echo cmake -S "%_GPT_SOURCES_DIR%" -G "Visual Studio 17 2022" -B "%_GPT_BUILD_DIR%" -DCMAKE_INSTALL_PREFIX="%_LLVM_BIN_DIR%" -DCMAKE_BUILD_TYPE="%_GPT_BUILD_TYPE%"
call cmake -S . -G "Visual Studio 17 2022" -B "%_GPT_BUILD_DIR%" -DCMAKE_INSTALL_PREFIX="%_LLVM_BIN_DIR%" -DCMAKE_BUILD_TYPE="%_GPT_BUILD_TYPE%"
